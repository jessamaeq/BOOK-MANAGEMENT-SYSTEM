...
<html lang = "eng">
	...
	<body style = "background-color:#d3d3d3;">
		<nav class = "navbar navbar-default navbar-fixed-top">
			<div class = "container-fluid">
				<div class = "navbar-header">
					...
					<h4 class = "navbar-text navbar-right">FR. SATURNINO URIOS UNIVERSITY</h4>
				</div>
			</div>
		</nav>
		<div class = "container-fluid">
		...
		<nav class = "navbar navbar-default navbar-fixed-bottom">
			<div class = "container-fluid">
				<label class = "navbar-text pull-right">FSUU Library System &copy; All rights reserved 2023</label>
			</div>
		</nav>
	</body>
